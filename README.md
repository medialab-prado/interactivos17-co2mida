...
+ La exposición está formada por: dos pantallas, unos auriculares, un ratón, una mesa de juego (con un mastil que invita a jugar), una caja con el juego y cuatro sillas. La pantalla de la derecha, muestra, en repetición, el vídeo realizado (si el vídeo dejase de aparecer, está guardado en el escritorio bajo el nombre "CO2MIDAPROJET.mp4) en una carpeta ("co2mida". En esta carpeta también hay un link a la página web) y en la de la izquierda aparece la web (co2mida.wordpress.com. Esta pantalla necesita conexión a internet). Además hay un mapa realizado en cartón, hilo y caretlitos colgados con chinchetas que tiene que estar entre las pantallas y acompañado de un folleto. Además del expositor, hay una mesa y cuatro sillas para que se pueda jugar al juego de mesa. En la mesa está la caja con el juego dentro. 

+ Elementos del juego de mesa: una caja para guardarlo + cuatro tableros con el esquema de cadena de producción A3 que se doblan por la mitad + folio con instrucciones + 96 cartas (3 cartas guía. 24 cartas de objetivos. 8 cartas de estación. 9 cartas de procesado. 8 cartas de granja.18 cartas de transporte. 16 cartas de cultivo y 10 de pesca).  
...
+ Es necesario que el juego de mesa esté siempre completo, que las pantallas estén funcionando y que el mapa no esté desmoronado. El mapa tiene que tener 4 cartelitos ("mercado municipal", "tienda de barrio", "tienda ecológica" y "gran superficie" clavados cada uno con una chincheta) unidos entre sí por un hilo tenso. En los márgenes del mapa están pegadas unas tablas explicativas y la leyenda de las mismas. 
